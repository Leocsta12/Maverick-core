import { athleteRiskStatus, attentionRank, checkInStatus, daysSince, type AthleteOverview } from '../coachOverview';
...
describe('attentionRank', () => {
  ...
  it('risco de carga alto vem em PRIMEIRO lugar — até antes de "sumiu do app"', () => {
