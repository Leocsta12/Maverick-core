// ESPELHO de src/lib/periodization.ts — ver comentário no topo de
// trainingLoad.ts (mesma pasta) sobre por que é cópia, não import.
import type { LoadRisk } from './trainingLoad.ts';
