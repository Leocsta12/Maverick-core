// ESPELHO de src/lib/trainingLoad.ts — copiado, não importado, porque o
// app (Node/Metro) e as Edge Functions (Deno) são toolchains separadas
// sem um jeito direto de compartilhar módulo. Usado pela Edge Function
// notify-athletes pra decidir QUANDO mandar push de deload/carga. Se
// mudar o algoritmo de um lado, replica no outro — são as mesmas funções
// puras (zero import externo), risco de divergência é só de disciplina,
// não estrutural.
